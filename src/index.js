...
class ParameterControl {
    ...
    static onTypeIsArrayClick(id) {
        document
            .querySelector(`#root_param > .param.block[data-id="${id}"] .param_input_type_isarray`)
...
<div class="command_parameter_group" data-id="${COMMAND_MAIN_PARAM_COUNT}">
            ...
            <div class="list_cell">
              ...
              <span class="param_input_type_isarray"
                onclick="CommandControl.onTypeIsArrayClick(${COMMAND_MAIN_PARAM_COUNT})">&nbsp;array&nbsp;</span>
            </div>
            <div class="list_cell">
